...
const PostCommentSection = ({ isOpen, checkAuth }) => { 
  if (!isOpen) return null;

  const handleSubmitComment = () => {
     checkAuth("Đăng nhập để bình luận.");
  };
    ...
    <div className="bg-slate-900 border-t border-slate-700 p-4 animate-fade-in">
      ...
      <div className="flex gap-2">
        ...
        <button 
          ...
          className="bg-cyan-600 hover:bg-cyan-500 text-white rounded-full p-2 w-8 h-8 flex items-center justify-center transition-colors"
        >
